...
export const services = ref([
  {
    title: "Capacitación, Asesoría y Auditoria en ISO 9001, 14001, 45001, 27001, 27701, 27017, 27018, 27032, 22301, 20000-1, 26000, 28000, 39001, 37001, 50001, 55001, 37301, 39001 entre otras.",
  ...
  {
    title: "ITIL",
    content: "ITIL se centra en las mejores prácticas para la gestión de servicios de TI, proveyendo un marco para entregar servicios de tecnología de la información eficientes y alineados con las necesidades del negocio. Este enfoque mejora la calidad del servicio de TI, gestionando procesos, funciones y roles de manera efectiva.",
    imageUrl: image11,
    idTitle: "itil",
    inverted: false
  },
